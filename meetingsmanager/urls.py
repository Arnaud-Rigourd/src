...
from meetingsmanager.views import MeetingsCreate, MeetingsIndex, MeetingsUpdate, MeetingsDelete, MessagesCreateDev
...
urlpatterns = [
    ...
    path('meetings/my_meetings/messages/create/<int:meeting_pk>/', MessagesCreateDev.as_view(), name="message-create"),
]
